...
const char* password = "";
const String appName = "Wiguna_SmartPhone_Test";
const String devName = "DHT22";
const String accessKey = "77ba6bbd753bb4fc:c41cdb8ccf97bdcf";
...
//https://github.com/farizalemuda/widyaedu-iot/blob/master/Edspert_Modul_6_1_DHT22/Edspert_Modul_6_1_DHT22.ino
